...
# Deployment configuration written by the setup wizard. The reader is shared
# with backup-loop.sh, which is its own entrypoint and therefore never runs
# this script -- see docker/read-config.sh for why that mattered.
